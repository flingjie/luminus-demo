...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__4729__auto__,writer__4730__auto__,opt__4731__auto__){
return cljs.core._write(writer__4730__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__4131__auto__ = reagent.impl.template.named_QMARK_(x);
...
var or__4131__auto__ = reagent.impl.template.hiccup_tag_QMARK_(x);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
var G__10157 = o;
(G__10157[reagent.impl.template.cached_prop_name(k)] = reagent$impl$template$convert_prop_value(v));
...
var old_10161 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_(old_10161))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_10161)].join(''):class$));
} else {
}
...
if(cljs.core.not((function (){var and__4119__auto__ = (node === document.activeElement);
if(and__4119__auto__){
var and__4119__auto____$1 = reagent.impl.template.has_selection_api_QMARK_((node["type"]));
...
if(cljs.core.truth_((function (){var and__4119__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__10164 = jsprops;
(G__10164["defaultValue"] = value);

(G__10164["onChange"] = ((function (G__10164,v,value,on_change){
return (function (p1__10162_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__10162_SHARP_);
});})(G__10164,v,value,on_change))
);
...
var vec__10166 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10166,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10166,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10166,(2),null);
...
var temp__4427__auto__ = (function (){var G__10170 = cljs.core.meta(v);
var G__10170__$1 = (((G__10170 == null))?null:reagent.impl.template.get_key(G__10170));
return G__10170__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__10172_10173 = v;
var G__10172_10174__$1 = (((G__10172_10173 == null))?null:reagent.impl.template.key_from_vec(G__10172_10173));
var G__10172_10175__$2 = (((G__10172_10174__$1 == null))?null:(jsprops["key"] = G__10172_10174__$1));
...
var G__10179 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__10179) : reagent.impl.template.as_element.call(null,G__10179));
} else {
var p = (function (){var temp__4427__auto__ = (function (){var G__10180 = cljs.core.meta(argv);
var G__10180__$1 = (((G__10180 == null))?null:reagent.impl.template.get_key(G__10180));
return G__10180__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__10181 = (((jsprops == null))?{}:jsprops);
(G__10181["key"] = key);
...
var G__10182 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__10182;
continue;
}
} else {
...
var n__5034__auto___10183 = a.length;
var i_10184 = (0);
while(true){
if((i_10184 < n__5034__auto___10183)){
(a[i_10184] = reagent.impl.template.as_element((a[i_10184])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__5034__auto___10186 = a.length;
var i_10187 = (0);
while(true){
if((i_10187 < n__5034__auto___10186)){
var val_10188 = (a[i_10187]);
if((cljs.core.vector_QMARK_(val_10188)) && ((reagent.impl.template.key_from_vec(val_10188) == null))){
(o["no-key"] = true);
} else {
}

(a[i_10187] = reagent.impl.template.as_element(val_10188));

var G__10189 = (i_10187 + (1));
i_10187 = G__10189;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__4119__auto__ = cljs.core.not(reagent.impl.component._STAR_non_reactive_STAR_);
if(and__4119__auto__){
return (ctx["no-key"]);
} else {
return and__4119__auto__;
...
var G__10191 = (cljs.core.count(argv) - first_child);
switch (G__10191) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__10191){
